...
def apply_indicators(df: pd.DataFrame, cfg: IndicatorConfig) -> pd.DataFrame:
    ...
    # ── Donchian Channel ──────────────────────────────────────────────────────
    df["donchian_upper"] = high.rolling(cfg.donchian_period).max()
    df["donchian_lower"] = low.rolling(cfg.donchian_period).min()
    ...
    # ── Volume ────────────────────────────────────────────────────────────────
    df["volume_avg"] = volume.rolling(cfg.volume_avg_window).mean()
